...
/// Temporal query markers — phrases that signal a query is asking about time,
/// ordering, recency, duration, or chronological relationships.
/// Used by `infer_query_mode` to activate temporal retrieval boosts.
pub const TEMPORAL_QUERY_MARKERS: &[&str] = &[
    // Direct time words
    "time",
    "when",
    "date",
